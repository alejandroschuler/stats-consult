...
Note that **all appointments begin on the hour**. For example, if you schedule for 9:30, please show up at 9. Google calendar does not allow scheduling multiple appointments concurrently, but for most hours we actually have two consultants present so if you show up on the hour someone will likely be there to help you sooner.

**Walk-ins** are also welcome, you can check the calendar below to see our availability.

All consults are held in **BWW 5422 Schaeffer**, Virtual consults are also available by appointment **for OOMPH students**: simply add a zoom link when prompted by the signup form.
